...
export default function TrainingTheConsultant() {
  return (
    ...
    lg:p-20 bg-primary-10 items-start">
      ...
      2xl:text-5xl text-primary">Training The Consultant</h2>
      ...
      lg:text-[14px] xl:text-lg 2xl:text-xl">With the help of our Training Consultants program, 
      ...
      lg:text-[14px] xl:text-lg 2xl:text-xl">
        {consultantPrograms.map((course => <li key={course.heading} className="flex flex-col gap-3">
          ...
          xl:text-lg 2xl:text-xl">{course.heading}</span>
